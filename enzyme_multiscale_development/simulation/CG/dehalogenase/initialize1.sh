...
cp -a $AAREF_DIR/seed_$i/dhaaa_seed${i}_10ns.gro ./

# Martinize to obtain a protein-only PDB file and topology
martinize2 -f dhaaa_seed${i}_10ns.gro -x dehalogenase_cg-proteinonly.pdb -ff martini3001 -from charmm -p backbone -ignh -ignore SOL -ignore NA -ignore CLA -elastic
