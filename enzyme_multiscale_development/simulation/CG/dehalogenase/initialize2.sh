...
GMX_APP=/home/mason/code/containers/gmx21_5.sif
AAREF_DIR=/home/mason/dmref/dehalogenase/aa/production
...
BOXDIMS=`tail dhaaa_seed${i}_10ns.gro -n 1`
$GMX_APP gmx editconf -f dehalogenase_cg.pdb -box $BOXDIMS -o dehalogenase_cg.gro

# em in vacuum. pilots showed this was fine, tutorial agrees
$GMX_APP gmx grompp -f minim.mdp -c dehalogenase_cg.gro -p topol_cg.top -o em.tpr
$GMX_APP gmx mdrun -pin on -v -deffnm em

## solvate. larger radius is from tutorial
$GMX_APP gmx solvate -cp em.gro -cs water.gro -radius 0.21 -o dehalogenase_cg_sol.gro
