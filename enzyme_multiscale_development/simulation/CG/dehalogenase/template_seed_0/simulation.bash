...
$GMX_APP gmx grompp -f md.mdp -c npt1.gro -p topol_cg.top -o dehalogenase_cg_md.tpr
$GMX_APP gmx mdrun -ntomp 16 -v -deffnm dehalogenase_cg_md -cpi dehalogenase_cg.cpt
